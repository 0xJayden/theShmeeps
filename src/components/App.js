...
import sjPass from '../images/sjpassmockup.png'
import excitedImage from '../images/excited.png'
import xsjPass from '../images/xsjpassmockup.png'
import './App.css'
		...
		<div>
			<nav className="navbar fixed-top mx-3">
				<a
					...
					href="http://www.sanjosefoos.com/"
					target="_blank"
					rel="noopener noreferrer"
				>
					<img src={sjPass} className="App-logo" alt="logo" />
					San Jose Foos
				</a>
			...
			<main>
				<Row className="my-3">
					<Col className="text-center">
						<h1 className="text-uppercase">SJ Pass</h1>
						<p className="countdown">
							{revealTime !== 0 && <Countdown date={currentTime + (revealTime - currentTime)} />}
						</p>
						<p>Mint your free SJ Pass (not including gas fees) on 1/01/22</p>
					</Col>
				</Row>
				<Row className="my-4">
